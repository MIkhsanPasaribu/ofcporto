...
export default function Footer() {
  ...
  // Function to toggle admin link visibility after 5 rapid clicks
  let clickCount = 0;
    ...
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h2 
              className="text-xl font-bold mb-4 cursor-default" 
              onClick={handleLogoClick}
            >
              M. Ikhsan Pasaribu
            </h2>
            <p className="text-gray-300">
              Showcasing my professional journey, skills, and projects.
            </p>
            {adminLinkVisible && (
              <Link 
                href="/admin/login" 
